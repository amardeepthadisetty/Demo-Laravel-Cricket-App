...
class SubSubCategoryController extends Controller
{
    ...
    {
        //print_r(SubSubCategory::where('id', $request->subsubcategory_id)->get());
        //die;
        $brand_ids = json_decode(SubSubCategory::where('id', $request->subsubcategory_id)->get());
        $brands = array();
        foreach ($brand_ids as $key => $brand_id) {
            //print_r($key);
            //echo "<pre>";
           // var_dump($brand_id->brands);
            $brandIDS = json_decode($brand_id->brands);
            //var_dump($brandIDS);
            //print_r($brandIDS);
            foreach ($brandIDS as $b) {
               
                array_push($brands,  Brand::where('id', $b)->get());
            }
            //echo "\n\n\n\"";
           // print_r(Brand::where('id', 'all', $brandIDS)->get());
