...
class SellerWithdrawRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('desktop.seller.seller_withdraw_requests.index', compact('seller_withdraw_requests'));
    }
    ...
    public function message_modal(Request $request)
    {
        ...
        if (Auth::user()->user_type == 'seller') {
            return view('desktop.partials.withdraw_message_modal', compact('seller_withdraw_request'));
        }
