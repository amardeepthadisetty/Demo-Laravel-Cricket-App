...
<div class="row">
	<form class="form form-horizontal mar-top" action="{{route('filtergroups.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
		@csrf
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="filter_group_name" placeholder="{{__('Filter Group Name')}}"  required>
								</div>
							</div>
