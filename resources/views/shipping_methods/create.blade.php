...
<div class="row">
	<form class="form form-horizontal mar-top" action="{{route('shippingmethod.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
		@csrf
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="shipping_name" placeholder="{{__('Shipping Name')}}"  required>
								</div>
							</div>
