...
<div class="row">
	<form class="form form-horizontal mar-top" action="{{route('templatecategories.update', $template->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
		<input name="_method" type="hidden" value="POST">
		<input type="hidden" name="id" value="{{ $template->id }}">
		@csrf
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title">{{__('Template Category Information')}}</h3>
			</div>
				        ...
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                ...
	                                <input type="hidden" name="category_id" value="{{ $template->id }}">
	                            </div>
	                        </div>
                           ...
                           // }
	                        ...
	                        @endphp
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" id="parent_id_name" name="parent_id_name" placeholder="Type to get suggestions" data-role="" value="{{   $data['name'] }}">
									<input type="hidden" id="parent_id" name="parent_id" value="{{ $template->parent_id }}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									...
									<div id="filters">
										...
										@if( $template->filters ) 
											@foreach( $template->filters as $fIDS )
												@php  
												...
												@endphp
												<div >
													<button id="{{ $fIDS }}" type="button" class="removeCatItem btn btn-purple btn-xs">X</button>
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									...
									<label class="switch" style="margin-top:5px;">
										<input value="{{ $template->is_template }}" type="checkbox" name="is_template" @php if($template->is_template =="1" ){ echo "checked"; } @endphp >
...
$('#slug').on('keyup', function(){
		...
		$.post('{{ route('template_categories.slug_check') }}',{_token:'{{ csrf_token() }}', slug_check:'edit', slug_value: this.value}, function(data){
