...
<!-- Global style (main) -->
<!--<link type="text/css" href="{{ asset('frontend/css/global.css') }}" rel="stylesheet" media="screen">-->
...
<!-- Web Fonts -->
<link type="text/css" href="{{ asset('frontend/css/web-font.css') }}" rel="stylesheet">
...
<div class="body-wrap">
    ...
    <!-- Header -->
    @include('desktop.frontend.inc.nav')

    @yield('content')

    @include('desktop.frontend.inc.footer')

    @include('desktop.frontend.partials.modal')
...
@if(Session::has('error'))
     <script type="text/javascript">
        showFrontendAlert('error', '{{ Session::get('error') }}');
    </script>
@endif
...
@if (Session::has('warning'))
    <script type="text/javascript">
       ...
       // showFrontendAlert('warning', '{{ Session::get('warning') }}' );
    </script>
@endif
