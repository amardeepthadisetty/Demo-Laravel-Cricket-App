...
<link type="text/css" href="{{ asset('frontend/css/forms.css') }}" rel="stylesheet" media="screen"> 
                            ...
                            <div class="text-center px-35 pt-5">
                                <h3>
                                    ...
                                    @if(Session::has('error'))
                                        <p class="success text-error">{{ Session::get('error') }}</p>
                                    @endif
                                </h3>
                            </div>
                                        ...
                                        <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col text-center">
                                                    <button type="submit" class="btn btn-styled btn-md w-100">{{ __('Login') }}</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
