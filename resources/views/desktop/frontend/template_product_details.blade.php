                        ...
                        <div class="product-description-wrapper">
                           ...
                           {{--  <ul class="breadcrumb">
                            ...
                            <div class="row no-gutters py-4 d-none" id="chosen_price_div">
                                ...
                                <input type="hidden" name="template_id" value="{{ $template->ref }}">
                                ...
                                @foreach(json_decode(json_encode($product->additional_options)) as $key => $opt)
                                    ...
                                    @switch(trim($opt->option_type))
                                        ...
                                        <div class="row pd-section">
                                                    <div class="col-12">
                                                        <div class="product-description-label mt-2 ">{{ $opt->title }}</div>
                                                    </div>
                                                    <div class="col-12 mt-1">
                                ...
                                <!--  Upload Module Start  -->
                                    @include('desktop/frontend/partials/template_upload_part')
                                <!--  Upload Module End  -->


                                @foreach(json_decode(json_encode($template->additional_options)) as $key => $opt)
                                        ...
                                        <div class="col-12 mt-1">
                                            <ul class="list-inline">
                                                ...
                                                @endphp
                                                    ...
                                                    <textarea class="form-control instructions" name="instructions" placeholder="Instructions">{{ $instructions_value  }}</textarea>
                                    ...
                                    <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="card-image">
                                                <a href="{{ route('template.product',[ 'tmpslug' => $template->slug, 'prodslug' => $prod->slug ]) }}" class="d-block" style="background-image:url('{{ asset( getImageURL( $imageURL ,'thumbnail') ) }}');">
                                                </a>
                                            </div>
                                            ...
                                            <div class="p-3">
                                                ...
                                                <h2 class="product-title p-0 text-truncate-2">
                                                     <a href="{{ route('template.product',[ 'tmpslug' => $template->slug, 'prodslug' => $prod->slug ]) }}" tabindex="0">{{ __($template->name.' '.$prod->name) }}</a>
                                                </h2>
                                                <div class="price-box">
                                              
                                                    <span class="product-price strong-600">

                                                        {{ format_price( $template->display_price ) }}
                                    ...
                                    <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <h2 class="product-title p-0 text-truncate-2">
                                                    <a href="{{ route('product', $prod->slug) }}">{{ __($prod->name) }}</a>
                                                </h2>
                                                <div class="price-box">
