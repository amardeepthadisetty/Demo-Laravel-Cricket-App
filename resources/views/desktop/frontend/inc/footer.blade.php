            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-3">
                        ...
                        <ul class="footer-links">
                            <li><a href="{{ env('APP_URL').'/product/digital-painting' }}">Digital Painting</a></li>
                            <li><a href="{{ env('APP_URL').'/product/oil-painting' }}">Oil Painting</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Caricature-Art' }}">Caricature Art</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Photo-Canvas' }}">Photo Canvas</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Backlit-Frame' }}">Backlit Frame</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Backlit-Frame' }}">Handmade Art</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Posters' }}">Posters</a></li>
                ...
                <div class="col-lg-3 col-md-3">
                        ...
                        <h4> Photo Gifts</h4>
                        <ul class="footer-links">
                            <li><a href="{{ env('APP_URL').'/cat-Mugs' }}">Mugs</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Photo-Crystals' }}">Photo Crystals</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Word-Frames' }}">Word Frames</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Alu--MDF-Frames' }}">Alu & MDF Frames</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Aluminium-Photo-Frames' }}">Aluminium Photo Frames</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Glass-Photo-Frames' }}">Glass Photo Frames</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-LED-Photo-Frames' }}">LED Photo Frames</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Mobile-Cases' }}">Mobile Cases</a></li>
                            <li><a href="{{ env('APP_URL').'/cat-Photo-Frames' }}">Photo Frames</a></li>
