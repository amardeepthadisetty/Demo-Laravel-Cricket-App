            ...
            <div class="container">
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-xl-8">
                        ...
                        @endif
                        <form class="form-default" id="form_submit" data-toggle="validator" action="{{ route('fill_later.store_delivery_method_info') }}" role="form" method="POST">
                            @csrf
                            ...
                            @if(Session::get('delivery_type')!="local_pickup")        
                               <div class="row">
