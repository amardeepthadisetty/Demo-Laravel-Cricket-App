        ...
        <section class="gry-bg" id="cart-summary">
            <div class="container">
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-xl-8">
                        <div>
                            Reference Order ID  #{{ Session::get('order_id') }}
                        </div>
                        <form class="form-default" data-toggle="validator" action="{{ route('checkout.order_submit') }}" role="form" method="POST">
                            @csrf
                            @php
                                        ...
                                        <div class="col-md-12 py-3 payment-op">
                                                    ...
                                                    <div class="row">
                                                        <div class=" col-md-12">
                                                                ...
                                                                <p>    
                                                                    Payment Method <span> 
                                                                        @if(Session::get('payment_option')=="cash_free")
                                                                        Cash Free
                                                                        @else
                                                                        Paytm
                                                                        @endif
