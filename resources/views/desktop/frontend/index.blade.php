...
<link type="text/css" href="{{ asset('frontend/css/testimonial.css') }}" rel="stylesheet" media="screen"> 
<link type="text/css" href="{{ asset('frontend/css/slider.css') }}" rel="stylesheet" media="screen">   
...
@section('content')
    <section class="home-banner-area">
            ...
            <div class="no-gutters position-relative">
                            ...
                            <div class="slick-carousel" data-slick-arrows="true"  data-slick-autoplay="true">
                                @foreach (\App\Slider::where('published', '1')->get() as $key => $slider)
                                    <div class="" style="height:auto;">
                                        <img loading="lazy"  class="d-block w-100 " src="{{ asset('public/'.$slider->photo) }}" alt="Slider Image">
                                    </div>
                                @endforeach
                            </div>
                        </div>
             ...
             <section class="featured-products text-center">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="pr-span">
                            <a href="{{ env('APP_URL').'/product/digital-painting' }}">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="pr-span">
                            <a href="{{ env('APP_URL').'/product/oil-painting' }}">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="pr-span">
                            <a href="{{ env('APP_URL').'/category/Caricature-Art' }}">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="pr-span">
                            <a href="{{ env('APP_URL').'/category/handmade-art' }}">
             ...
             <section class="popular-collections text-center">
                <div class="container">
                 ...
                 <div class="col-6 col-md-3 col-lg-3">
                    <div class="pr-span">
                            <a href="{{ env('APP_URL').'/category/Photo-Canvas' }}">
                ...
                <div class="col-6 col-md-3 col-lg-3">
                    <div class="pr-span">
                            <a href="{{ env('APP_URL').'/category/Mugs' }}">
                ...
                <div class="col-6 col-md-3 col-lg-3">
                    <div class="pr-span">
                            <a href="{{ env('APP_URL').'/category/Photo-Wooden-Cut-Outs' }}">
            ...
            <section class="trending-products text-center">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="pr-span">
                            <a href="{{ env('APP_URL').'/category/Backlit-Frame' }}">
                        ...
                        <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                            <div class="card-body p-0">
                                ...
                                <div class="card-image">
                                    <a href="{{ route('categories', $cat->slug) }}" class="d-block" style="background-image:url('{{ asset($cat->thumbnail_img) }}');">
                                    </a>
                                </div>
                                ...
                                <div class="p-3">
                                    ...
                                    <h2 class="product-title p-0 text-truncate-2">
                                        <a href="{{ route('product', $cat->slug) }}">{{ __($cat->name) }}</a>
                                    </h2>
                                </div>
                            </div>
                        </div>
