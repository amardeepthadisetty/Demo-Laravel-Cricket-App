...
<div class="row">
	<form class="form form-horizontal mar-top" action="{{route('templates.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
		@csrf
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="name" placeholder="{{__('Template Name')}}" onchange="update_sku();" required>
								</div>
							</div>
	                            ...
	                            <div class="col-lg-7">
	                                <select class="form-control template_products " name="products_add[]" multiple="multiple"  required>
	                                	...
	                                	@foreach($products as $prod)
		                                	<option value="{{ $prod->ref }}">{{ $prod->name }}</option>
	                                	@endforeach
	                                </select>
	                            </div>
	                        </div>
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="model" placeholder="{{__('Model')}}" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="base_price" placeholder="{{__('Base Price')}}" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="display_price" placeholder="{{__('Display Price')}}" required>
								</div>
							</div>
						...
						{{-- <div id="demo-stk-lft-tab-8" class="tab-pane fade">
				         ...
				         <div id="demo-stk-lft-tab-11" class="tab-pane fade">
							...
							<div class="form-group upload_limit_div">
										...
										<div class="col-lg-7">
											<input type="number" min="0" step="0.01" placeholder="{{__('Upload Limit')}}" name="upload_limit" class="form-control" value="" >
										</div>
							</div>
