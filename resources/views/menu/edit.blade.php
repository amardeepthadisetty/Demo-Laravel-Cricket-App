...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('menu_includes/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css') }}">
    ...
    <body>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
	                    ...
	                    <div class="form-group">
	                    	<form class="form form-horizontal mar-top" action="{{route('menu.update', 2)}}" method="POST"  >
							...
							@csrf
		                    	...
		                    	<input type="hidden" value="{{ $menu->menu }}" name="json_data" id="json_data">
	                    	</form>
	                    </div>
	                    </div>
                    </div>
        ...
        <script type="text/javascript" src="{{ asset('menu_includes/jquery-menu-editor.min.js')  }}"></script>
        <script type="text/javascript" src="{{ asset('menu_includes/bootstrap-iconpicker/js/iconset/fontawesome5-3-1.min.js')  }}"></script>
        <script type="text/javascript" src="{{ asset('menu_includes/bootstrap-iconpicker/js/bootstrap-iconpicker.min.js')  }}"></script>
        <script>
            ...
            $( "#category_id_name" ).autocomplete({
		      source: function(d,e){
		        ...
		        $.ajax({
		               type:"POST",
		               url: '{{ route('ajax.categories.menu') }}',
