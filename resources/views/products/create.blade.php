				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="product_type" placeholder="{{__('Product Type')}}" value=""   required>
	                            </div>
	                        </div>
				         ...
				         <div id="demo-stk-lft-tab-11" class="tab-pane fade">
							...
							<div class="promotion_div">
								<div class="form-group ">
											...
											<div class="col-lg-7">
												<input type="text" placeholder="{{__('Text')}}" name="promotion_text" class="form-control" value="" >
											</div>
								</div>
								...
								<div class="form-group upload_limit_div">
											<label class="col-lg-2 control-label">{{__('Discount')}}</label>
											<div class="col-lg-7">
												<input type="number" placeholder="{{__('Text')}}" name="promotion_discount" class="form-control" value="0" >
											</div>
								</div>
...
<script type="text/javascript">
	...
	function update_option_sku(ref_row){
		...
		$.ajax({
		   type:"POST",
		   url:'{{ route('products.more_options') }}',
		   data:{
