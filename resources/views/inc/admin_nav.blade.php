               ...
               {{--  @php
                ...
                <li class="dropdown" id="lang-change">
                    ...
                    <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                        <img loading="lazy"  src="{{ asset('frontend/images/icons/flags/'.$locale.'.png') }}" class="flag" style="margin-right:6px;"><span class="language">En</span>
                    </a>
                ...
                <li id="dropdown-user" class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                        <ul class="head-list">
                            <li>
                                <a href="/profile/index"><i class="demo-pli-male icon-lg icon-fw"></i> {{__('Profile')}}</a>
                            </li>
                            <li>
                                <a href="/logout"><i class="demo-pli-unlock icon-lg icon-fw"></i> {{__('Logout')}}</a>
                            </li>
                        </ul>
                    </div>
                </li>
