                        ...
                        <div class="col-lg-9">
                            <select name="coupon_type" id="coupon_type" class="form-control demo-select2-placeholder" onchange="coupon_form()" required>
                                ...
                                <?php elseif($coupon->type == "category_base"): ?>
                                    <option value="category_base"><?php echo e(__('For Categories')); ?></option>
                                <?php elseif($coupon->type == "shipping_base"): ?>
                                    <option value="shipping_base"><?php echo e(__('For Shipping')); ?></option>        
                                <?php endif; ?>
                            </select>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/coupons/edit.blade.php ENDPATH**/ ?>