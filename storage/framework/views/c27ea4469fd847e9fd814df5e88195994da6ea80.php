...
<div class="product-choose-list">
    <div class="product-choose">
         <div class="form-group">
           <label class="col-lg-3 control-label"><?php echo e(__('Product')); ?></label>
           <div class="col-lg-9">
              <select class="form-control demo-select2" name="product_ids[]" >
...
<?php /**PATH C:\xampp\htdocs\laramongo\resources\views/partials/product_base_coupon.blade.php ENDPATH**/ ?>