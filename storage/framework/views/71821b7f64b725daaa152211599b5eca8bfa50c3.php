...
<?php endif; ?>
<a href="<?php echo e(route('products.admin')); ?>" class="btn btn-rounded btn-info pull-right"> Normal Products </a>
<a href="<?php echo e(route('template_products.admin')); ?>" class="btn btn-rounded btn-info pull-right">Template Products </a>
                ...
                <tbody>
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('product', $product->slug)); ?>" target="_blank"><?php echo e(__($product->slug)); ?></a></td>
                            <td>
                                <?php 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/products/index.blade.php ENDPATH**/ ?>