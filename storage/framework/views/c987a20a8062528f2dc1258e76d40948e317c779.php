...
<!-- Global style (main) -->
<!--<link type="text/css" href="<?php echo e(asset('frontend/css/global.css')); ?>" rel="stylesheet" media="screen">-->

  <!-- <link type="text/css" href="<?php echo e(asset('frontend/css/active-shop.css')); ?>" rel="stylesheet" media="screen">  -->

<link href="https://fonts.googleapis.com/css?family=Playfair+Display:400,500&display=swap" rel="stylesheet">
...
<!-- Web Fonts -->
<link type="text/css" href="<?php echo e(asset('frontend/css/web-font.css')); ?>" rel="stylesheet">
...
<div class="body-wrap">
    ...
    <!-- Header -->
    <?php echo $__env->make('desktop.frontend.inc.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->yieldContent('content'); ?>

    <?php echo $__env->make('desktop.frontend.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('desktop.frontend.partials.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php if(Session::has('error')): ?>
     <script type="text/javascript">
        showFrontendAlert('error', '<?php echo e(Session::get('error')); ?>');
    </script>
<?php endif; ?>

<?php if(Session::has('success')): ?>
    <script type="text/javascript">
        showFrontendAlert('success', '<?php echo e(Session::get('success')); ?>' );
    </script>
<?php endif; ?>

<?php if(Session::has('warning')): ?>
    <script type="text/javascript">
        alert("<?php echo e(Session::get('warning')); ?>");
       // showFrontendAlert('warning', '<?php echo e(Session::get('warning')); ?>' );
    </script>
<?php endif; ?>
...
<script>
    ...
    function getVariantPrice(){
      //alert("hello clicked, getVariantPrice");
         $('.loading-text').show();
    ...
    function checkAddToCartValidity(){
        ...
        //console.log("input radio checked count is: ", $('input:radio:checked').length);
    ...
    function addToCart(){
        if(checkAddToCartValidity()) {
            ...
            $.ajax({
               ...
               success: function(data){
                   ...
                   if (data.status=="success") {
                       ...
                       for (let i = 0; i < errors.length; i++) {
                           let idValue = errors[i].idValue;
                           let message = errors[i].message;
                           $('#'+idValue).text(message).addClass('error_span');
               ...
               error: function(xhr, xmlrequest){
                console.log("error is:", xhr, xmlrequest);
                $('.loading-text').hide();
               }
           });
        }
...
<?php /**PATH C:\xampp\htdocs\laramongo\resources\views/desktop/frontend/layouts/app.blade.php ENDPATH**/ ?>