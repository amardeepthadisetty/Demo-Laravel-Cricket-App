...
<div class="row">
	<form class="form form-horizontal mar-top" action="<?php echo e(route('filtergroups.store')); ?>" method="POST" enctype="multipart/form-data" id="choice_form">
		<?php echo csrf_field(); ?>
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="filter_group_name" placeholder="<?php echo e(__('Filter Group Name')); ?>"  required>
								</div>
							</div>
							...
							<table class="table-bordered">
								...
								<tbody class="filter_name_div">
									<tr>
										<td>
											<input value="" type="text" required name="filter_name[]" placeholder="Filter Name">
										</td>
										<td>
											<input value="" type="text" required name="filter_sort[]" placeholder="Sort order" >
										</td>
										<td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/filtergroups/create.blade.php ENDPATH**/ ?>