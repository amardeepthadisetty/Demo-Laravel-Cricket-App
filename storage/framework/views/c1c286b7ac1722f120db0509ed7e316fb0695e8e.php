...
<?php
 $product_upload = json_decode(json_encode($product->more_settings));  
?>
<div class="row pd-section">
<?php if($product_upload->upload_settings->is_upload=="1"): ?>
<div class="col-12">
...
<div class="col-12 mt-1">
    ...
    <span class="input_file">
        ...
        <input type="file" id="upload_file" name="upload[]" <?php if($product_upload->upload_settings->upload_limit >= 2) { echo 'multiple'; }  ?>  accept='image/*' >
        <input type="hidden" id="upload_limit" value="<?php echo e($product_upload->upload_settings->upload_limit); ?>" >
        <input type="hidden" id="photos" name="user_photos" value="<?php echo e($images); ?>" >
    </span>
    <div id="for_images">
        <?php echo $imagesHTML; ?>
...
$("#upload_file").change(function(e) {
   ...
   // form_data.append('fileupload[]', $('#upload_file')[0].files[0]);
    form_data.append('product_id', '<?php echo e($product->id); ?>');
    $.ajax({
        url : '<?php echo e(route('upload.user_upload_file')); ?>',
        type: "POST",
...
</script><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/desktop/frontend/partials/upload_part.blade.php ENDPATH**/ ?>