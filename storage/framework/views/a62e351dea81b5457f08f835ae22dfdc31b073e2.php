            ...
            <div class="container">
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-xl-8">
                        ...
                        <?php endif; ?>
                        <form class="form-default" id="form_submit" data-toggle="validator" action="<?php echo e(route('checkout.store_delivery_method_info')); ?>" role="form" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php
                            ...
                            <div class="card mb-3" >
                                ...
                                <?php if(Session::get('fill_later')!="local_pickup"): ?>
                                <?php  
                                                ...
                                                Shipping Info
                                                   ...
                                                   <?php echo e($shipping_info['state']); ?>  <br>
                                                    ...
                                                    <p>  <?php if($shipping_info['fill_later']=="fill_later"): ?>  
                                                         ...
                                                         <?php elseif($shipping_info['fill_later']=="local_pickup"): ?> 
...
<?php echo $__env->make('desktop.frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/desktop/frontend/delivery_method.blade.php ENDPATH**/ ?>