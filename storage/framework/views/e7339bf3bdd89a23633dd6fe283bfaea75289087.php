                    ...
                    <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php if($coupon->type == 'cart_base'): ?>
                                    <?php echo e(__('For Total Orders')); ?>

                                <?php elseif($coupon->type == 'product_base'): ?>
                                    <?php echo e(__('For Products')); ?>

                                <?php elseif($coupon->type == 'category_base'): ?>
                                    <?php echo e(__('For Category')); ?>

                                <?php elseif($coupon->type == 'shipping_base'): ?>
                                    <?php echo e(__('For Shipping')); ?>         
                            <?php endif; ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/coupons/index.blade.php ENDPATH**/ ?>