                                        ...
                                        <div class="col-md-6 mx-auto">
                                            <div class="row">
                                                ...
                                                <?php endif; ?>
                                                 ...
                                                 <?php if(\App\BusinessSetting::where('type', 'cash_free')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Cash Free">
...
<?php echo $__env->make('desktop.frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/desktop/frontend/payment_select.blade.php ENDPATH**/ ?>