	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<td class="text-center">
					<label for="" class="control-label"><?php echo e(__('Weight in')); ?> <?php echo e($product->unit); ?></label>
				</td>
			</tr>
		</thead>
		<tbody>
...
<?php $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<?php if(strlen($str) > 0): ?>
		<tr>
			...
			<td>
				<input type="text" name="weight_<?php echo e($str); ?>" value="<?php
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laramongo\resources\views/partials/sku_combinations_edit.blade.php ENDPATH**/ ?>