...
<div class="row">
	<form class="form form-horizontal mar-top" action="<?php echo e(route('filtergroups.update', $fg->id)); ?>" method="POST" enctype="multipart/form-data" id="choice_form">
		<?php echo csrf_field(); ?>
		<input type="hidden" name="added_by" value="admin">
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title"><?php echo e(__('Filter Groups')); ?></h3>
			</div>
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
								<label class="col-lg-2 control-label"><?php echo e(__('Filter Group Name')); ?></label>
								<div class="col-lg-7">
									<input type="text" class="form-control" name="filter_group_name" placeholder="<?php echo e(__('Filter Group Name')); ?>" value="<?php echo e($fg->name); ?>"  required>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-lg-2 control-label"><?php echo e(__('Sort Order')); ?></label>
								<div class="col-lg-7">
									<input type="text" value="<?php echo e($fg->sort_order); ?>" class="form-control" name="sort_order" placeholder="sort order" >
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" value="<?php echo e($fg->slug); ?>" class="form-control" name="slug" placeholder="slug" >
								</div>
							</div>
							...
							<table class="table-bordered">
								...
								<tbody class="filter_name_div">
									...
									<?php if( $fg->filters ): ?>
									<?php $__currentLoopData = $fg->filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ids): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
									...
									?>
										...
										<tr>
											<td>
												...
												value="<?php echo e($filterNameClass->name); ?>" 
												>
											</td>
											<td>
												<input type="text" required name="filter_sort[]" placeholder="Sort order" value="<?php echo e($filterNameClass->sort); ?>" >
											</td>
											<td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/filtergroups/edit.blade.php ENDPATH**/ ?>