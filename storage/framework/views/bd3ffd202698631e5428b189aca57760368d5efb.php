            ...
            <div class="container">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-lg-10 col-4 position-static">
                        <div class="d-flex w-100">
                            <div class="search-box flex-grow-1 px-4">
                                <form action="<?php echo e(route('search_post')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                ...
                                ?>
                                        <div class="form-group category-select d-none d-xl-block">
                                            <select class="form-control selectpicker" name="search_type">
                                                <option value="all" <?php echo e($all); ?>>All</option>
                                                <option value="normal_products" <?php echo e($nP); ?>>Products</option>
                                                <option value="template_products" <?php echo e($tP); ?> >Templates</option>
                                        ...
                                        <div class="w-100">
                                            ...
                                            ?>
                                            <input type="text" aria-label="Search" id="search" name="q" class="w-100" placeholder="I'm shopping for..." autocomplete="off" value="<?php echo e($search_string); ?>">
                                        </div>
                    ...
                    <ul class="inline-links">
                        ...
                        <?php else: ?>
                        <li>
                            <a href="<?php echo e(route('user.login')); ?>" class="top-bar-item"><?php echo e(__('My Account')); ?></a>
                        </li>
                        <li>
                            <!-- <a href="<?php echo e(route('user.registration')); ?>" class="top-bar-item"><?php echo e(__('Registration')); ?></a> -->

                            <a href="" class="top-bar-item"><?php echo e(__('Offers')); ?></a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li>
                            ...
                            <div class="d-inline-block" data-hover="dropdown">
                                <div class="nav-cart-box dropdown" id="cart_items">
                                    <a href="<?php echo e(route('cart')); ?>" class="nav-box-link" >
                ...
                <div class="collapse navbar-collapse  justify-content-center" id="navbar_main">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-classic">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-classic">
                            <ul class="navbar-nav ">
                                <?php if( $json_beautified ): ?>
                                    <?php $__currentLoopData = $json_beautified; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $first_level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if( empty( $first_level->children ) ): ?>
                                            <li class="nav-item">
                                                <a class="nav-link" href="<?php echo e(env('APP_URL').'/'.$first_level->href); ?>">
                                                <?php echo e($first_level->text); ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <li class="nav-item dropdown mega-dropdown">
                                                <a class="nav-link dropdown-toggle" href="<?php echo e(env('APP_URL').'/'.$first_level->href); ?>">
                                                <?php echo e($first_level->text); ?>
                                                ...
                                                <?php if( !empty( $first_level->children ) ): ?>
                                                    <div class="dropdown-menu mega-dropdown-menu">
                                                            <div class="row">
                                                    <?php $__currentLoopData = $first_level->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $second_level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                        
                                                                
                                                               
                                                                <div class="col-md-3">
                                                                <div class=""><h4><span> <a href="<?php echo e(env('APP_URL').'/'.$second_level->href); ?>"><?php echo e($second_level->text); ?></a></span></h4>
                                                                    <?php if( !empty( $second_level->children ) ): ?>
                                                                    <ul class="menu">
                                                                    <?php $__currentLoopData = $second_level->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $third_level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <li> <a href="<?php echo e(env('APP_URL').'/'.$third_level->href); ?>"><?php echo e($third_level->text); ?></a></li>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </ul>
                                ...
                                <!-- <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(env('APP_URL')); ?>/cat-Photo-To-Art">
                                    Photo to Art
                                    </a>
...
<?php /**PATH C:\xampp\htdocs\laramongo\resources\views/desktop/frontend/inc/nav.blade.php ENDPATH**/ ?>