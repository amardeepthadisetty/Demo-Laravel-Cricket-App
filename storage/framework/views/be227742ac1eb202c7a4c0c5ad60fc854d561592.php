<link type="text/css" href="<?php echo e(asset('frontend/css/forms.css')); ?>" rel="stylesheet" media="screen"> 
                            ...
                            <div class="text-center px-35 pt-5">
                                <h3>
                                    ...
                                    <?php if(Session::has('error')): ?>
                                        <p class="success text-error"><?php echo e(Session::get('error')); ?></p>
                                    <?php endif; ?>
                                </h3>
                            </div>
                                        ...
                                        <form class="form-default" role="form" action="<?php echo e(route('login')); ?>" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group  login-style">
                                            ...
                                            <div class="row">
                                                <div class="col text-center">
                                                    <button type="submit" class="btn btn-styled btn-md w-100"><?php echo e(__('Login')); ?></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
<?php echo $__env->make('desktop.frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/desktop/frontend/user_login.blade.php ENDPATH**/ ?>