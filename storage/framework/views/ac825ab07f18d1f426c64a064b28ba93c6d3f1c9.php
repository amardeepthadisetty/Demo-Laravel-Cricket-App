<?php $__env->startSection('content'); ?>
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo e(__('Orders Information')); ?></h3>
        </div>
                                                                ...
                                                                <td>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="">
                                                                            ...
                                                                            <a href="<?php echo e(route('orders.order_details.orderid', $order->id)); ?>" class="dropdown-item"><?php echo e(__('Order Details')); ?></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/orders/index.blade.php ENDPATH**/ ?>