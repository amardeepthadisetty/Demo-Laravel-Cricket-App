                    ...
                    <div class="col-lg-6">
                        <div class="product-gal sticky-top d-flex flex-row-reverse">
                            <?php
                                ...
                                $prod_id_image = $product->ref.'_images';

                                $product_images = json_decode( json_encode( $template->product_images , FALSE) );

                                $product->photos = array();
                                if( !empty( $product_images->$prod_id_image )  ){
                                    $product->photos = $product_images->$prod_id_image;
                                }

                            
                            
                            $product->photos = array_merge($product->photos, $template->photos);
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-description-wrapper">
                            ...
                            <h1 class="product-title">
                                <?php echo e(__($template->name.' '.$product->name)); ?>
                            ...
                            <div class="row no-gutters py-4 d-none" id="chosen_price_div">
                                    <div class="col-1">
                                ...
                                <input type="hidden" name="template_id" value="<?php echo e($template->ref); ?>">
                                ...
                                <?php $__currentLoopData = json_decode(json_encode($product->additional_options)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php switch(trim($opt->option_type)):
                                        ...
                                        <div class="row pd-section">
                                                    <div class="col-12">
                                                        <div class="product-description-label mt-2 "><?php echo e($opt->title); ?></div>
                                                    </div>
                                                    <div class="col-12 mt-1">
                                ...
                                <!--  Upload Module Start  -->
                                    <?php echo $__env->make('desktop/frontend/partials/template_upload_part', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <!--  Upload Module End  -->


                                <?php $__currentLoopData = json_decode(json_encode($template->additional_options)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-12 mt-1">
                                            <ul class="list-inline">
                                                ...
                                                ?>
                                                    ...
                                                    <textarea class="form-control instructions" name="instructions" placeholder="Instructions"><?php echo e($instructions_value); ?></textarea>
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    <?php else: ?>
                                        <button type="button" class=" btn-styled btn-base-1">
                            ...
                            <div class="row no-gutters mt-3">
                                <div class="col-12">
                                    <div class="product-description-label">{{__('Return Policy')}}:</div>
                                </div>
                                <div class="col-12 mt-1">
                           ...
                           <hr class="mt-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 small-des mt-4">
                                    <?php echo $template->small_description; ?>
                                </div>
                            </div>
             ...
             <?php if( count( $product_array )>0 ): ?>
                    <div class="container">
                            ...
                            <div class="section-title-1 clearfix">
                                <h4>
                                    <span class="mr-4">Similar Products</span>
                                </h4>
                            </div>
                            <div class="caorusel-box">
                                <div class="slick-carousel" data-slick-items="5" data-slick-xl-items="4" data-slick-lg-items="3"  data-slick-md-items="2" data-slick-sm-items="2" data-slick-xs-items="1">
                                    <?php $__currentLoopData = $product_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php 
                                            $prod_image_name = $prod->ref.'_images';
                                    ...
                                    <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="card-image">
                                                <a href="<?php echo e(route('template.product',[ 'tmpslug' => $template->slug, 'prodslug' => $prod->slug ])); ?>" class="d-block" style="background-image:url('<?php echo e(asset( getImageURL( $imageURL ,'thumbnail') )); ?>');">
                                                </a>
                                            </div>
                                            ...
                                            <div class="p-3">
                                                ...
                                                <h2 class="product-title p-0 text-truncate-2">
                                                     <a href="<?php echo e(route('template.product',[ 'tmpslug' => $template->slug, 'prodslug' => $prod->slug ])); ?>" tabindex="0"><?php echo e(__($template->name.' '.$prod->name)); ?></a>
                                                </h2>
                                                <div class="price-box">
                                              
                                                    <span class="product-price strong-600">

                                                        <?php echo e(format_price( $template->display_price )); ?>
                                    ...
                                    <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <h2 class="product-title p-0 text-truncate-2">
                                                    <a href="<?php echo e(route('product', $prod->slug)); ?>"><?php echo e(__($prod->name)); ?></a>
                                                </h2>
                                                <div class="price-box">
...
<?php echo $__env->make('desktop.frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/desktop/frontend/template_product_details.blade.php ENDPATH**/ ?>