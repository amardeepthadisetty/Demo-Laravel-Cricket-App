		...
		<table class="padding text-left small border-bottom">
			...
			<tbody class="strong">
                <?php $__currentLoopData = $order->orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                ...
	                <?php if($product != null): ?>
						<tr class="">
							<td><?php echo e($product->name); ?> (<?php echo e($orderDetail->variation); ?>)</td>
							<td>
...
<?php /**PATH C:\xampp\htdocs\laramongo\resources\views/invoices/customer_invoice.blade.php ENDPATH**/ ?>