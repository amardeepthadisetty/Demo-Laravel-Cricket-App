        ...
        <section class="gry-bg address-form">
            <div class="container">
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-lg-8">
                        <form class="form-default" id="user_details" data-toggle="validator" action="<?php echo e(route('checkout.store_shipping_infostore')); ?>" role="form" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="card"> 
                                <?php if(Auth::check()): ?>
                                    <?php
                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback">
                                                     ...
                                                     <label class="control-label"><?php echo e(__('Fill Later')); ?>
...
<?php echo $__env->make('desktop.frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramongo\resources\views/desktop/frontend/shipping_info.blade.php ENDPATH**/ ?>